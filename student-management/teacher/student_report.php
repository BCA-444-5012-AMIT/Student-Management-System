...
if ($studentId === 0) {
    ...
    try {
        ...
        if ($enrollmentCheck['enrollment_count'] == 0) {
            $errorMessage = 'Student not found in your courses';
        } else {
            ...
            if (!$student) {
                ...
                // Get attendance statistics for teacher's courses only
                $stmt = $pdo->prepare("
                    SELECT 
                ...
                // Get detailed attendance records for teacher's courses only
                $stmt = $pdo->prepare("
                ...
                // Get enrollment information for teacher's courses only
                $stmt = $pdo->prepare("
